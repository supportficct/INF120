Public Class NEnt
    ...
    Public Sub NEnt() 'Constructor inicia un objeto
        n = 0
    End Sub

    Public Sub Cargar(ne As Integer)
        n = ne
    End Sub
    ...
    Public Sub CortarDigNdg(dig As Nent)
    ...
    Public Function Pnes6(ne As Nent)
        Dim c, na As Integer
        Dim b As Boolean
        b = True
        na = n
